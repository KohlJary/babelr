...
export const UI_STRINGS = {
  ...
  'wiki.sidebarHint': 'Select a tab above to view comments, history, or backlinks',
  ...
  // Onboarding wizard
  'onboarding.welcome': 'Welcome to Babelr',
  'onboarding.profileSubtitle': 'Set up your profile so others know who you are.',
  'onboarding.displayName': 'Display name',
  'onboarding.saving': 'Saving…',
  'onboarding.next': 'Next',
  'onboarding.back': 'Back',
  'onboarding.chooseLanguage': 'Choose your language',
  'onboarding.languageSubtitle': 'Messages will be automatically translated into this language.',
  'onboarding.setupServer': 'Set up your space',
  'onboarding.serverSubtitle': 'Create a new server or join an existing one.',
  'onboarding.createServer': 'Create',
  'onboarding.joinServer': 'Join',
  'onboarding.serverName': 'Server name',
  'onboarding.serverNamePlaceholder': 'My Team, Book Club, Open Source…',
  'onboarding.creating': 'Creating…',
  'onboarding.create': 'Create server',
  'onboarding.noServersToJoin': 'No servers available to join right now.',
  ...
  'twoFactor.recoveryHint': 'You can also use a recovery code.',
  'twoFactor.setup': 'Set up 2FA',
  'twoFactor.setupSubtitle': 'Scan the QR code with your authenticator app, then enter the 6-digit code to confirm.',
  'twoFactor.enterCode': 'Enter code from app',
  'twoFactor.confirm': 'Confirm',
  'twoFactor.confirming': 'Confirming…',
  'twoFactor.enabled': 'Two-factor authentication is enabled.',
  'twoFactor.disable': 'Disable 2FA',
  'twoFactor.disableConfirm': 'Enter a code to disable 2FA',
  'twoFactor.recoveryCodes': 'Recovery codes',
  'twoFactor.recoveryWarning': 'Save these codes somewhere safe. Each can only be used once.',
  'twoFactor.done': 'Done',
  ...
  'onboarding.embedEvent': 'Embed a calendar event',
  'onboarding.embedTask': 'Embed a work item',
  'onboarding.embedFile': 'Embed a shared file',
  'onboarding.embedsHow': 'Embeds render inline as clickable cards. Click one to open a translated preview in the sidebar — no context switching.',
  'onboarding.embedsCrossTower': 'Embeds work across federated Towers too. Reference content from any connected workspace.',
  'onboarding.allSet': "You're all set!",
  'onboarding.doneSubtitle': 'Your workspace is ready. Start chatting, collaborating, and building.',
